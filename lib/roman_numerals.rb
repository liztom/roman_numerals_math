def roman_numerals(number)
  raise ArgumentError, 'Inputted number is out of range' unless number < 4000 && number > 0
  ...
  number_array = number.to_s.split('').reverse.collect { |a| a.to_i }
